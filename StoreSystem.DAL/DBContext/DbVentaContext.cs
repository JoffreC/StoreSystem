...
namespace StoreSystem.DAL.DBContext;
...
//        => optionsBuilder.UseSqlServer("Server=localhost\\SQLEXPRESS;Database=DBVENTA;Integrated Security=True;TrustServerCertificate=True");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Categoria>(entity =>
        {
            entity.HasKey(e => e.IdCategoria).HasName("PK__Categori__8A3D240CF630D134");
        ...
        {
            entity.HasKey(e => e.IdDetalleVenta).HasName("PK__DetalleV__BFE2843F135845D0");
        ...
        {
            entity.HasKey(e => e.IdMenu).HasName("PK__Menu__C26AF483696AF210");
        ...
        {
            entity.HasKey(e => e.IdNegocio).HasName("PK__Negocio__70E1E107091AE582");
        ...
        {
            entity.HasKey(e => e.IdNumeroCorrelativo).HasName("PK__NumeroCo__25FB547E21984806");
        ...
        {
            entity.HasKey(e => e.IdProducto).HasName("PK__Producto__07F4A1324FFF121F");
        ...
        {
            entity.HasKey(e => e.IdRol).HasName("PK__Rol__3C872F7686E1465A");
        ...
        {
            entity.HasKey(e => e.IdRolMenu).HasName("PK__RolMenu__CD2045D89DC82922");
        ...
        {
            entity.HasKey(e => e.IdTipoDocumentoVenta).HasName("PK__TipoDocu__A9D59AEE804CD074");
        ...
        {
            entity.HasKey(e => e.IdUsuario).HasName("PK__Usuario__645723A65743D43C");
        ...
        {
            entity.HasKey(e => e.IdVenta).HasName("PK__Venta__077D5614CB80A5FB");
